...
class RpaLogSuccess(models.Model):

    rpa = models.ForeignKey(Rpa, on_delete=models.CASCADE, related_name='log_success_id_rpa')
    start_time = models.DateTimeField()
    end_time = models.DateTimeField()
    duration = models.DurationField(default=0,null=True, blank=True)
    rpa_log_status = models.CharField(max_length=50, choices=[('success','Success')], default='success')
